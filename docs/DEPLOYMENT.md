...
**Netlify**
- Similar to Vercel
- Better for built-in forms/serverless functions
- 100GB bandwidth free tier
- Excellent private repo support
- **Decision:** Using Vercel instead (simpler for current needs)
